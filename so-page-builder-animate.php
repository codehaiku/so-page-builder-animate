 ...
 * License: GPL2
 *
 * @package so-page-builder-animate
 */
...
function spba_libraries()
{
    ...
    * Version - 3.4.0
     */
    wp_enqueue_style('spba-animate', plugins_url('/css/animate.min.css', __FILE__), '3.4.0', true);

    /**
     * WOW - v1.1.2 - 2015-08-19
     */
    wp_enqueue_script('spba-wow', plugins_url('/js/wow.min.js', __FILE__), array( 'jquery' ), '1.1.2', true);

    /**
     * this scripts depends on spab-wow being loaded
     * 0.3 is this plugin version
     */
    wp_enqueue_script('so-page-builder-animate', plugins_url('/js/so-page-builder-animate.js', __FILE__), array( 'spba-wow' ), '0.3', true);
